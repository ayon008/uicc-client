...
const Page = () => {
    ...
    const links = [
        'IELTS', 'Visa Processing', 'Air Ticket', 'Korean Language', 'Japanese Language', 'Chinese Language', 'German Language'
    ];
    const Icon = () => {
        return (
    ...
    return (
        <div>
            {
                tabIndex === 0 && <ServiceBanner text={'IELTS'} />
            }
            {
                tabIndex === 1 && <ServiceBanner text={'Worker Visa Services'} />
            }
                        ...
                        <ul className='space-y-4'>
                            {
                                links.map((link, i) => {
                                    return (
                                        <li key={i} onClick={() => setTabIndex(i)} className={`flex items-center gap-4 rounded-xl p-6 ${tabIndex === i ? 'bg-orange text-white' : 'bg-white text-black'}`} style={{
                                            boxShadow: "0px 0px 8px 4px rgba(0, 0, 0, 0.05)"
                                        }}>
                                            {tabIndex === i ? <WhiteIcon /> : <Icon />}
                                            <span className='2xl:text-2xl xl:text-xl font-medium'>{link}</span>
                                        </li>
                                    )
                                })
                            }
                    ...
                    </div>
                    {
                        tabIndex === 1 && (
                            <div>
                                ...
                                <h2 className='2xl:text-5xl xl:text-4xl font-semibold mt-6'>
                                    Types of Worker Visas We Assist With
                                </h2>
                                ...
                                <h2 className='2xl:text-5xl xl:text-4xl font-semibold'>
                                    Key Visa Requirements We Help You Meet
                                </h2>
                                <ul className='space-y-5 mt-10'>
                                    <li className='flex items-center'>
                                        <TickIcon />
                                ...
                                <h2 className='2xl:text-5xl xl:text-4xl font-semibold mt-10'>
                                    Post-Visa Support
                                </h2>
                                <ul className='space-y-5 mt-10'>
                                    <li className='flex items-center'>
