...
const Page = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            await updatedProfile(name, '') // Perform your sign-in logic
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body pb-0">
                        ...
                        <div className="form-control">
                            <input
                                ...
                                className={`email input input-bordered ${errors.name && "input-error"}`}
                        ...
                        <div className="form-control">
                            <input
                                ...
                                className={`email input input-bordered ${errors.password ? 'border-red-500' : ''}`}
                            />
                        ...
                        <div className="form-control">
                            <input
                                ...
                                className={`email input input-bordered ${errors.confirmPassword ? 'border-red-500' : ''}`}
                            />
                        ...
                        <div className="flex items-end gap-2">
                            ...
                            />
                            <p className='text-white opacity-65 mt-2'>
                                I agree <span className='text-orange'>term and condition</span>
                            </p>
                        </div>
                        ...
                        <div>
                            <p className="text-center text-white">
                                <span>Already have an account?</span> <Link href={'/signIn'} className="text-deep-blue">Log In</Link>
                            </p>
                        </div>
